    ...
    <section id="contact" className="py-24 bg-gradient-to-r from-gray-900 to-gray-700 text-white">
      ...
      >
        ...
        <form
          ...
          className="bg-gray-800 rounded-2xl p-4 sm:p-6 shadow-lg w-full max-w-full"
        >
          <input
            type="text"
            name="name"
...
function HomePage() {
  return (
    <div className="font-sans scroll-smooth bg-white text-gray-900 overflow-x-hidden">
      <Navbar />
      <Hero />
      <About />
      <Skills />
